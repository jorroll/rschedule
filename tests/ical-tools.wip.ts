import { serializeToICal, serializeToJCal } from '@rschedule/ical-tools';
    ...
    zones.forEach(zone => {
      ...
      context(zone, timezone => {
        ...
        it('deserializes | serializes | deserializes', () => {
          ...
          const parsed = parseICal(ical, StandardDateAdapter)[0].events[0] as Schedule<
            typeof StandardDateAdapter
          >;
        ...
        describe('parseICal()', () => {
                ...
                events: [
                  {
                    ...
                    exdates: [],
                    exrules: [],
                    rdates: [dateAdapter(1997, 8, 2, 9, 0, 0)],
                    rrules: [
                      {
                        byDayOfWeek: ['SU', 'MO', 'TU', 'WE', 'TH', 'FR', 'SA'],
                        byMonthOfYear: [1],
                        frequency: 'YEARLY',
                        start: dateAdapter(1997, 8, 2, 9, 0, 0),
                        until: dateAdapter(2000, 0, 31, 14, 0, 0),
                      },
                    ],
                  },
                ],
                ...
                events: [
                  {
                    ...
                    exdates: [dateAdapter(1997, 6, 14, 12, 30, 0).toJSON()],
                    exrules: [],
                    rdates: [
                      dateAdapter(1997, 6, 14, 12, 30, 0).toJSON(),
                      dateAdapter(1997, 6, 14, 12, 30, 0).toJSON(),
                      dateAdapter(1997, 8, 2, 9, 0, 0).toJSON(),
                    ],
                    rrules: [
                      {
                        byDayOfWeek: ['TU', 'TH'],
                        frequency: 'WEEKLY',
                        start: dateAdapter(1997, 8, 2, 9, 0, 0).toJSON(),
                        until: dateAdapter(1997, 9, 7, 0, 0, 0).toJSON(),
                        weekStart: 'SU',
                      },
                    ],
                  },
          ...
          it('handles INVALID_STRING_FIVE', () => {
            ...
            ).toThrowError(`invalid line (no token ";" or ":") "dfDDDdveajdfdoih3289hxfd"`);
          });
        ...
        describe('deserializes | serializes | deserializes', () => {
          ...
          it('works', () => {
            const parsed = parseICal(ical, MomentTZDateAdapter)[0].events[0] as Schedule<
        ...
        describe('serializes and deserializes Schedule to VCALENDAR', () => {
          ...
          const schedule = new Schedule({
            rrules: [
              ...
              {
                frequency: 'DAILY',
                start: dateAdapter(2010, 10, 11, 0),
                count: 2,
                byHourOfDay: [9],
              },
            ],
