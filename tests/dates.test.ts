import { RDates, DateProp, OccurrencesArgs, Options, IDateAdapter, IDateAdapterConstructor, DateAdapterConstructor, DateAdapter } from '@rschedule/rschedule'
...
describe('RDatesClass', () => {
  it('is instantiable', () => expect(
    new RDates({ dateAdapter: DateAdapter })
  ).toBeInstanceOf(RDates))
})
