import { DateTime } from '@rschedule/rschedule';
...
describe(`DateTimeClass`, () => {
  ...
  it('isInstance()', () => {
    expect(DateTime.isInstance(1)).toBeFalsy();
    expect(DateTime.isInstance('1')).toBeFalsy();
    expect(DateTime.isInstance({})).toBeFalsy();
    expect(DateTime.isInstance(DateTime)).toBeFalsy();
    expect(DateTime.isInstance(new Date())).toBeFalsy();
    expect(DateTime.isInstance(dateTime())).toBeTruthy();
  });
