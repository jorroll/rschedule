...
const INVALID_STRING_FIVE =
`DTSTART:19970902T090000
dfDDDdveajdfdoih3289hxfd
`;
const INVALID_STRING_SIX =
`DTSTART:19970902T090000
...
describe('parseICalString()', () => {
  ...
  it('parses RRULE_STRING_TWO', () => {
    expect(parseICalString(RRULE_STRING_TWO)).toEqual({
      ...
      RRULE: [{
        propertyName: 'RRULE',
        propertyValue: 'FREQ=WEEKLY;UNTIL=19971007T000000Z;WKST=SU;BYDAY=TU,TH',
      }],
      RDATE: [
        {
          propertyName: 'RDATE',
      ...
      BEGIN: [{
        ...
        BEGIN: [
          ...
          },
          {
            ...
            SUMMARY: [{
              propertyName: 'SUMMARY',
              propertyValue: 'Event repeating weekly on a Wednesday at 11am',
            }],
            TRANSP: [{
              propertyName: 'TRANSP',
              propertyValue: 'OPAQUE',
          ...
          },
          {
            ...
            SUMMARY: [{
              propertyName: 'SUMMARY',
              propertyValue: 'Event repeating monthly on 2nd tuesday at 10am',
            }],
            TRANSP: [{
              propertyName: 'TRANSP',
              propertyValue: 'OPAQUE',
  ...
  it('handles INVALID_STRING_ONE', () => {
    expect(parseICalString(INVALID_STRING_ONE, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
    })
  })

  it('handles INVALID_STRING_TWO', () => {
    expect(parseICalString(INVALID_STRING_TWO, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
      DEINT: [{
        propertyName: 'DEINT',
  ...
  it('handles INVALID_STRING_THREE', () => {
    expect(parseICalString(INVALID_STRING_THREE, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
    })
  })

  it('handles INVALID_STRING_FOUR', () => {
    expect(parseICalString(INVALID_STRING_FOUR, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
    })
  })

  it('handles INVALID_STRING_FIVE', () => {
    expect(parseICalString(INVALID_STRING_FIVE, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
      DTSTART: [{
        propertyName: 'DTSTART',
        propertyValue: '19970902T090000',
  ...
  it('handles INVALID_STRING_SIX', () => {
    expect(parseICalString(INVALID_STRING_SIX, {ignoreParsingErrors: true})).toEqual({
      componentName: 'ROOT',
      DTSTART: [{
        propertyName: 'DTSTART',
        propertyValue: '19970902T090000',
